// GENERADO POR tools/set_version.py — no editar a mano.
//
// La version se toca con:
//   python tools/set_version.py 1.0.0.b
//
...
const String appVersion = '1.0.0.b';

/// Version numerica, la que llevan los metadatos del ejecutable.
const String appVersionNumeric = '1.0.0.2';

/// Numero de revision derivado del sufijo de letras (2).
const int appVersionBuild = 2;
