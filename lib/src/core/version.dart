...
//   python tools/set_version.py 1.0.0.d
//
...
const String appVersion = '1.0.0.d';

/// Version numerica, la que llevan los metadatos del ejecutable.
const String appVersionNumeric = '1.0.0.4';

/// Numero de revision derivado del sufijo de letras (4).
const int appVersionBuild = 4;
